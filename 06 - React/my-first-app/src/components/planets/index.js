...
const Planets = () => {
  return (
    <Fragment>
      ...
      <Planet
        name="Mercurio"
        descripton="Mercúrio é o menor e mais interno planeta do Sistema Solar, orbitando o
      ...
      <Planet
        name="Plutão"
        descripton="Plutão, formalmente designado 134340 Plutão, é um planeta anão do Sistema Solar e o nono maior e décimo mais massivo objeto observado diretamente orbitando o Sol."
